...
import devices from "../components/data/device.json";
import itembrand from "../components/data/itembrand.json";
import brandProcessor from "../components/data/brandProcessor.json";
...
useEffect(() => {
  ...
  const initialInventoryLoad = () => {
    ...
    API.inventryItemList(dispatch,filterRequest).then(res => {
  ...
  return (
    ...
    <div className="page mt-3 scrollable-div-summary">
      ...
      {/* <div className="d-flex justify-content-between align-items-center mb-2">
        ...
        <span className="badge bg-primary fs-6">Total Items: {initialInventory?.filter(item => item.quantity !== 0).length || 0}</span>
      </div> */}
        {/* <BorderHeader message="Inventory Dashboard" /> */}
      ...
      <div className="mb-3 text-end">
        ...
        <button className="modern-clear-btn" onClick={clearFilters}>
          Clear Filters
        </button>
        <button className="modern-clear-btn" onClick={searchFilters}>
          Search
        </button>
      </div>
      {/* <div className="mb-3 text-end">
            ...
            <div className="row g-3">
              ...
              <div className="col-md-3">
                <select
                  ...
                  style={{ height: 30, borderRadius: 8, borderColor: "#d9d9d9" }}
                  name="itemQuantity"
                  value={filterRequest.itemQuentity || ""}
                  onChange={(e) => {
                    handleFilter("itemQuentity", e.target.value);
                  }}
                >
        ...
        <table className="table table-hover table-bordered mb-0">
          <thead className="table-dark">
            <tr>
              ...
              <th className="col-2"><center>Item Code</center></th>
              <th className="col-1"  style={{ whiteSpace: "nowrap" }}>Item Name</th>
              <th className="col-1">Brand</th>
              <th className="col-1">Model</th>
              <th className="col-1">Condition</th>
            ...
            {initialInventory.length >0 ? (
              initialInventory.map((i, idx) => (
                <tr key={i.id}>
                  ...
                  <td>
                    <Tooltip text={
                        ...
                        <div>
                          ...
                          <strong>Item Name:</strong> {i.categoryType || "-"} <br />
                          <strong>Item Condition :</strong> {i.itemCondition || "-"} <br />
                  ...
                  <td className="col-1">{i.categoryType}</td>
